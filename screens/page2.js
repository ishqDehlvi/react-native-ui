    ...
    return(
        <StyledContainer>
            <InnerContainer>
                ...
                <PageLogo style={{top: -420}} resizeMode="cover" source={require('./../assets/img/logo.png')}/>
                ...
                <Formik>{({handleChange, handleBlur, handleSubmit,values}) => 
                        (<Cards style={{top: -550, width: 120,left: 70 }}>
                            ...
                            <StyledButton style={{shadowRadius: 5,shadowOpacity: 0.5,shadowOffset: { width: 0, height: 3 },shadowColor: '#000',backgroundColor: '#ff0000',top: 0, width: 100,height: 65, right: 0, 'border-radius':'15px'}} onPress = {handleSubmit}>
                                <ButtonText style={{color: '#000','font-weight': 'bold'}}>
                                    Stop
                                </ButtonText>
                            </StyledButton>
